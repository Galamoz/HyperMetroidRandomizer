...
namespace SuperMetroidRandomizer.IO
{
    public class RandomizerLog
    {
        ...
        public string GetLogOutput()
        {
            ...
            writer.AppendLine("Hyper Metroid Item Randomizer Log");
            writer.AppendLine("----------------------------");
            writer.AppendLine(string.Format("Version: 1.0", RandomizerVersion.CurrentDisplay));
            ...
            writer.AppendLine("--------");
            foreach (var location in generatedItems.Where(x => x.Item.Type != ItemType.Nothing && x.Region == Region.UpperBrinstar))
            {
                writer.AppendLine(string.Format("{0}{1}", location.Name.PadRight(47, '.'), GetItemName(location.Item)));
            }
            writer.AppendLine();
            ...
            writer.AppendLine();
            writer.AppendLine("Maridia Depths");
            writer.AppendLine("-------");
            foreach (var location in generatedItems.Where(x => x.Item.Type != ItemType.Nothing && x.Region == Region.MaridiaDepths))
            {
                writer.AppendLine(string.Format("{0}{1}", location.Name.PadRight(47, '.'), GetItemName(location.Item)));
            }
            writer.AppendLine();
